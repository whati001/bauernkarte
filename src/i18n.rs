...
mod tests {
    ...
    const ALL_KEYS: &[&str] = &[
        ...
        "search-no-results", "search-location-unavailable", "search-pick-on-map",
        ...
        "detail-edit-product", "detail-edit-product-title", "detail-edit-price",
